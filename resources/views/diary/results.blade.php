...
<div class="uk-section">
    <div class="uk-container uk-container-expand">
        <div class="uk-margin uk-width-1-2@m uk-align-center">
            ...
            <a class="uk-button uk-button-primary uk-button-large uk-align-center" href="/diary/create">Create New Entry</a>
            <hr class="uk-margin-large">
        </div>

        <div class="uk-margin">
            @foreach ($diaryEntries as $diaryEntry)
                <div class="uk-margin uk-width-1-2@m uk-align-center uk-card uk-card-default uk-padding uk-card-hover">
                    @if ($diaryEntry->title)
                        <p class="uk-margin-remove">{{ $diaryEntry->date }}</p>
                        <h2 class="uk-margin-remove uk-display-inline-block">{{ ucwords($diaryEntry->title) }}</h2>
                        <p class="uk-margin-top uk-display-inline-block uk-float-right uk-align-right"><a href="/diary/{{ $diaryEntry->id }}">View Entry</a></p>
                    @else
